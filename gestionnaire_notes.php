...
// Récupérer les classes distinctes uniquement pour la matière du professeur avec statistiques
$stmt = $mysqli->prepare("
    SELECT 
        classe,
        COUNT(DISTINCT eleve_username) as nb_eleves,
...
<head>
    ...
    <title>Gestionnaire des Notes - <?php echo htmlspecialchars($nom_complet); ?></title>
...
<body>
    <div class="container">
        ...
        <header class="profile-header">
            ...
            <div class="header-actions">
                <a href="professeur.php" class="btn btn-gradient">
        ...
        <div id="classes-view">
            <div class="page-title">
                <h2>
                    ...
                    Gestionnaire des Notes - <?php echo htmlspecialchars($matiere); ?>
                </h2>
                <p>Sélectionnez une classe pour gérer les notes</p>
            </div>
                    ...
                    <?php foreach ($classes as $classe): ?>
                        <div class="class-card" onclick="loadClassDetails('<?php echo htmlspecialchars($classe['classe']); ?>')">
                            ...
                            <div class="class-info">
                                ...
                                <p>Classe de <?php echo htmlspecialchars($matiere); ?></p>
                            </div>
                            <div class="class-stats">
                                ...
                                <div class="stat-item">
                                    ...
                                    <span>Moyenne: <?php echo $classe['moyenne']; ?>/20</span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
        ...
        <div id="class-detail-view" class="class-detail-view" style="display: none;">
            <div class="class-header">
                <div class="class-title">
                    ...
                    <div class="class-summary">
                        ...
                        <div class="summary-item">
                            <i class="fas fa-chart-line"></i>
                            <span id="class-average">Moyenne: 0/20</span>
                        </div>
                        <div class="summary-item">
                            <i class="fas fa-book"></i>
                            <span><?php echo htmlspecialchars($matiere); ?></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="students-container" id="students-container">
                <!-- Les notes des élèves seront chargées ici par JavaScript -->
            </div>
        </div>
    </div>
    ...
    <div id="deleteModal" class="modal" style="display: none;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="note-info" id="note-details">
                    <!-- Détails de la note à supprimer -->
                </div>
            </div>
    ...
    <script src="gestionnaire_notes.js"></script>
</body>
</html>
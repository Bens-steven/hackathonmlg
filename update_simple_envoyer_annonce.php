<?php
// Version mise à jour d'envoyer_annonce.php avec notifications simples
...
// Gestion du fichier joint (même code qu'avant)
$fichier_nom = null;
...
try {
    ...
    if ($stmt->execute()) {
        ...
        $push_success = sendSimplePushToAllStudents($notification_title, $notification_body, $notification_url);
        ...
        error_log("Annonce créée ID: $annonce_id, Push simple: " . ($push_success ? 'OK' : 'PARTIAL'));
